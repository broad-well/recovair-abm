...
for threshold in "10" "30" "60" "120" "180" "240" "300" "360"; do
    ...
    node test_scenario.js jan28-bts-import results-2024-01-28_$threshold > test_log_01-28_$threshold.log
    node test_scenario.js 2024-01-28-bts-import results-2024-01-28_$threshold-nodisrupt > test_log_01-28-nodisrupt_$threshold.log
    ...
    node test_scenario.js jan28-bts-import results-2024-01-28-aircraftdfs_$threshold > test_log_01-28-aircraftdfs_$threshold.log
